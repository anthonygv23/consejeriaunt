...
<div class="jumbotron">
    <h1 class="display-1">Pagina de consejeria</h1>
    <p class="lead">En esta pagina podras realizar la reservacion de una consejeria para preguntar sobre temas 
                    de tu interes y/o datos que no se lograron entender completamentamente en la hora de clase
    </p>
</div>
